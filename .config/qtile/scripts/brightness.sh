...
# icon
brightness_icon_high="~/.config/qtile/icons/brightness_high.png"
brightness_icon_medium="~/.config/qtile/icons/brightness_med.png"
brightness_icon_low="~/.config/qtile/icons/brightness_low.png"
